...
export function CountryPanel({
  ...
  return (
    <div className="country-panel-shell">
      <DetailsSheet
        resetKey={country.name}
        title={country.name}
        subtitle={`${country.peakCount} peak${country.peakCount === 1 ? '' : 's'} · highest ${formatElevation(country.highestPeak.elevationFt, units)}`}
        onClose={onClose}
        closeLabel="Back to world"
      >
